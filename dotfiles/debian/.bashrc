...
alias folder="nautilus" # arch, ubuntu use nautilus
...
# set repeat key speed
xset r rate 250 100

# nvim to be default editor
export EDITOR=vim

# terminal to use vim motions
# set -o vi
...
# ~/project dir link (to telescope)
export PROJECTDIR="$HOME/project" 

# Rust packages manager
. "$HOME/.cargo/env"

# Auto complete alacrity terminal
